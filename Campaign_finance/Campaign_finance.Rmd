...
## I am also curious how much crossover there is between Hogan and Schulz donors. I'm going to join those two datasets to see the crossover.
...
## There were 863 people or entities that contributed to Hogan's campaigns between 2015 and 2021 that also contributed to Schulz' campaign. 

hogan_schulz_joined %>%
  summarise(total = sum(`Contribution Amount.y`))

## This amounted to $1.22 million for the Schulz campaign. 
...
## That is just over 45% of all contributors to her campaign. It is shockingly 80% of the money she received in total.
``` 
